...
plt.title('Confusion Matrix Re Text Embdding (MLP)')
plt.xlabel('Predicted')
plt.ylabel('Actual')
plt.savefig('./graph/mlp_confusion_matrix_with_own_embedding.png')
plt.close()
...
plt.title('Receiver Operating Characteristic (ROC) Curve Re Text Embdding (MLP)')
plt.legend(loc="lower right")
plt.savefig('./graph/mlp_roc_curve_with_own_embedding.png')
plt.close()
...
plt.title('Precision-Recall Curve Re Text Embdding (MLP)')
plt.legend(loc="lower left")
plt.savefig('./graph/mlp_precision_recall_curve_with_own_embedding.png')
plt.close()

dump(best_model, './model/improved_mlp_model_with_ownembedding_kbest.joblib')
dump(preprocessor, './model/improved_preprocessor_mlp_with_ownembedding_kbest.joblib')
