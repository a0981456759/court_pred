...
X = pd.get_dummies(df[numerical_features + categorical_features], columns=categorical_features)
...
print("Zero R Prediction Performance (Without Embeddings):")
...
plt.title('Confusion Matrix (Zero R without Embeddings)')
plt.xlabel('Predicted')
plt.ylabel('Actual')
plt.savefig('./graph/confusion_matrix_zeror_without_embeddings.png')
plt.close()
...
plt.title('ROC Curve (Zero R without Embeddings)')
plt.legend(loc="lower right")
plt.savefig('./graph/roc_curve_zeror_without_embeddings.png')
plt.close()
...
plt.title('Precision-Recall Curve (Zero R without Embeddings)')
plt.legend(loc="lower left")
plt.savefig('./graph/precision_recall_curve_zeror_without_embeddings.png')
plt.close()
